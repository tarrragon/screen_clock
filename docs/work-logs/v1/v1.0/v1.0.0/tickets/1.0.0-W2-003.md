...
who:
  current: pending
  history: {}
what: 說明：建立可調樣式表單（fontSize slider、fontColor / strokeColor color picker、timeFormat
  dropdown、targetScreen dropdown、autoLaunch switch）。submit 後寫入 SettingsService。
when: 待定義
where:
  layer: Presentation
  files:
