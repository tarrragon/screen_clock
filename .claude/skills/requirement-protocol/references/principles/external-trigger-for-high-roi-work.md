...
> **角色**：本卡是 `requirement-protocol` 的支撐型原則（principle）、被 SKILL.md「相關抽象層原則」段與 reference `decision-dialogue.md` 引用、是說明「為什麼澄清 / Checkpoint 1 / RED phase 等動作需要協議結構強制、不能靠紀律」的 meta 原則。
>
