...
> **角色**：本卡是 `frontend-with-playwright` 的支撐型原則（principle）、被 SKILL.md「相關抽象層原則」段引用、是 [`verification-timeline-checkpoints.md`](./verification-timeline-checkpoints.md) 中 Checkpoint 1「列使用者意圖完整集」A11y 維度的展開。
>
