...
1. **AUQ 強制規則要求 Handoff 為第一選項**：`.claude/pm-rules/askuserquestion-rules.md`（場景 11）「Handoff 必須是第一選項且標記 (Recommended)」
...
- `.claude/pm-rules/askuserquestion-rules.md` — 場景 11 Handoff 推薦規則
